...
@Component({
  selector: 'app-view-jobseekers',
  templateUrl: './view-jobseekers.component.html',
  styleUrls: ['./view-jobseekers.component.css']
})
export class ViewJobseekersComponent implements OnInit {
